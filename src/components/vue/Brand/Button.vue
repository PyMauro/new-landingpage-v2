...
const handleClick = () => {
  console.log("Botón clickeado internamente");
  if (props.action) props.action(); // ejecuta la función que le pasaron
}
;
